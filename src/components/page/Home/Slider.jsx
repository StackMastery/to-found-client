...
const SimpleSlider = () => {
  return (
    <section className="flex justify-center py-10 w-full !text-black">
      <Swiper
        loop={true}
        slidesPerView={1}
        autoplay={{
        ...
        effect={"fade"}
        className="bg-neutral-200 w-full border items-center flex "
      >
        {SliderData &&
          SliderData.map((slider, index) => (
            <SwiperSlide
              ...
              key={index}
              className="h-full w-full !bg-white flex justify-center"
            >
              <div className="w-full h-full backdrop-blur-[3px] flex justify-center">
                <div className="flex swiperWidth flex-row items-center h-full  px-10 py-20 pt-28 xl:py-10 sm:px-14 md:px-20">
                  <div className="space-y-4 w-full lg:w-7/12">
                    <h2 className="text-2xl md:text-4xl font-semibold ">
                      {slider.title}
                    </h2>
                    <p className="text-sm md:text-base">
                      {slider.des.slice(0, 200)}
                    </p>
                    {slider.isNewsLetter ? (
                      <div className="pt-5">
                        <NewsletterInput />
                      ...
                      <Link to={slider.link} className="pt-5 flex">
                        ...
                        >
                          <Button
                            className={
                              "bg-sky-600 border-sky-600 text-white hover:border-black dark:!bg-black dark:text-white"
                            }
                          >
                            {slider.button}
                          </Button>

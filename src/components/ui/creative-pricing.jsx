...
const tiers = [
  {
    ...
    color: "amber",
    features: [
      "Up to 2 active posts per month",
  ...
  },
  {
    ...
    price: 49,
    description: "Ideal for frequent finders or posters",
    color: "blue",
    features: [
  ...
  },
  {
    ...
    price: 99,
    description: "For professionals and NGOs",
    color: "purple",
    features: [
      "Unlimited posts",
...
function CreativePricing({
  tag = "Pricing",
  title = "To Found pricing",
  description = "Get more fetures",
}) {
  return (
    <div className="w-full max-w-6xl mx-auto px-4 pt-20 md:pt-0 pb-28">
      <div className="text-center space-y-6 mb-16">
        ...
        <div className="relative">
          <h2 className="text-4xl md:text-5xl font-bold font-handwritten text-zinc-900 dark:text-white rotate-[-1deg]">
            {title}
            <div className="absolute -right-12 top-0 text-sky-600 rotate-12">
              ✨
            </div>
        ...
        {tiers.map((tier, index) => (
          ...
          >
            ...
            <div className="relative p-6">
              {tier.popular && (
                <div
                  className="absolute -top-2 -right-2 bg-sky-400 text-zinc-900 

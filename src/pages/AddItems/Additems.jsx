    ...
    <>
      ...
      <section className="flex justify-center pt-20 pb-40">
        <div className="w-primary px-5 inline-flex justify-center">
          <form
            onSubmit={addItem}
            className={`bg-cover dark:border-white/20 bg-no-repeat bg-center w-full border p-10 md:w-9/12 lg:w-[900px] rounded-xl`}
          >
            <div>
              <input
                accept="image/png, image/webp, image/avif, image/jpeg, image/svg+xml"
                disabled={thumbnail?.data}
                onChange={handelThumbnailUpload}
                type="file"
                id="thumbnail"
                className="hidden"
              />
              <label
                ...
                className="w-full bg-cover bg-center   flex-col gap-5 border-dashed border border-cyan-500/50 rounded-xl p-5 sm:p-14 md:p-20 flex items-center"
                htmlFor="thumbnail"
              >
                <div className="relative w-full group">
                  <div className="relative z-40 cursor-pointer dark:bg-white/10 bg-black/60 group-hover:translate-x-8 group-hover:shadow-2xl group-hover:-translate-y-8 transition-all duration-500 flex items-center justify-center h-32 w-32 mx-auto rounded-xl">
                    {!thumbnail === true ? (
                      <svg
            ...
            <div className="pt-5 flex justify-between gap-5 flex-wrap md:flex-nowrap">
              ...
              <div className="flex-grow-0 md:flex-grow w-full">
                ...
                <Popover>
                  <PopoverTrigger className="w-full items-center">
                    <div className="flex w-full justify-between items-center text-sm px-4 rounded-md py-2 border dark:border-white/20 dark:bg-white/10">
              ...
              <div className="flex-grow-0 md:flex-grow w-full">
                <label htmlFor="category" className="mb-1 flex">
                  Category
                </label>
            ...
            <div className="pt-5 flex justify-between gap-5">
              <div className="flex-grow">
                <label htmlFor="title" className="mb-1 flex">
                  Title
                </label>
            ...
            <div className="w-full flex justify-end pt-5">
              <Button
                className={
                  "border-sky-600 hover:border-black dark:text-black dark:hover:border-white/30 bg-sky-600 font-medium text-white"
                }
              >
                Add post{" "}
                {!isSaving === true ? (

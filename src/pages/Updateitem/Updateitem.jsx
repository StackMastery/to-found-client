...
const Updateitem = () => {
    ...
    const fetchCurrentPostData = async () => {
        ...
        setdate(data.lostDate)
        setthumbnail({data: data?.thumb})
        return data
    }
    ...
    const {
        ...
        queryKey: ['curentPostData'],
        queryFn: fetchCurrentPostData,
    ...
    const addItem = (e) => {
        ...
        axiosSecure.post(
            `/post/update?uid=${authInfo.uid}&postid=${curentPostData._id}`, 
            {
            ...
            toast.success('Post Updatest Succesfully')
    ...
    if(isLoading){
        return <AddItemLoader />
    }

    if(authInfo.email !== curentPostData?.email){
        return <NotFound />
    }
    ...
    return (
        <>
            <Helmet>
                <title>{curentPostData.title} Update | To Found</title>
            </Helmet>
            ...
            <section className="flex justify-center pt-20 pb-40">
                <div className="w-primary px-5 inline-flex justify-center">
                    <form onSubmit={addItem} className={`bg-cover bg-no-repeat bg-center w-full border p-10 md:w-9/12 lg:w-[900px] rounded-xl`}>
                        <div>
                            <input  accept="image/png, image/jpeg, image/svg+xml" disabled={thumbnail === true} onChange={handelThumbnailUpload} type="file" id="thumbnail" className="hidden" />
                        ...
                        <div className="pt-5 flex justify-between gap-5 flex-wrap md:flex-nowrap">
                            <div className="flex-grow-0 md:flex-grow w-full">
                                ...
                                <Select defaultValue={curentPostData?.postType}  name="postType" id="postype">
                            ...
                            <div className="flex-grow-0 md:flex-grow w-full">
                                ...
                                <Select defaultValue={curentPostData?.category} name="category" id="category">
                                    <SelectTrigger className="w-full">
                        ...
                        <div className="pt-5 flex justify-between gap-5">
                            <div className="flex-grow">
                                ...
                                <Input defaultValue={curentPostData.title} name="title" placeholder="Post title" id="title"/>
                            </div>
                        </div>
                        <div className="pt-5 flex justify-between gap-5">
                            <div className="flex-grow">
                                <label htmlFor="location" className="mb-1 flex">Location</label>
                                <Input defaultValue={curentPostData?.location} id="location" name="location" placeholder="Ex 132 My Street, Kingston" />
                            </div>
                        </div>
                        ...
                        <div className="pt-5">
                            <Tiptap defaultContent={curentPostData?.des} setContent={setContent} content={content}/>
                        </div>
